...
export function FloatingAgentCharacter({
  ...
  const displayImageUrl = imageUrl ? getAssetUrl(imageUrl) : null;
        ...
        <div className="w-full h-full relative" style={{ animation: peekAnim, transformStyle: 'preserve-3d' }}>
          {displayImageUrl ? (
            ...
            >
              ...
              <img src={displayImageUrl} alt="" className="w-full h-full object-cover object-center" referrerPolicy="no-referrer" />
            </div>
          ) : (
