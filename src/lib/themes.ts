...
export const THEMES: Theme[] = [
  ...
  },
  {
    ...
    emoji: '🎨',
    category: 'gradient',
    description: 'Modern doodles with vivid brush splashes.',
    bgGradient: 'from-fuchsia-500 via-orange-400 to-cyan-400',
    avatarStyle: 'glow',
    previewBg: '#f43f5e',
    previewText: '#fff7ed',
    vars: {
      ...
      '--tb-bg3': '#22d3ee',
      '--tb-text': '#fff7ed',
      '--tb-text2': 'rgba(255,247,237,0.92)',
      '--tb-border': 'rgba(255,255,255,0.28)',
      '--tb-radius': '18px',
      '--tb-font': '"Space Grotesk", system-ui, sans-serif',
      '--tb-font-display': '"Space Grotesk", system-ui, sans-serif',
      '--tb-shadow': '0 14px 44px rgba(244,63,94,0.32)',
      '--tb-card-style': 'glass',
      '--tb-link-style': 'pill',
    },
  },
  {
    ...
    emoji: '🍍',
    category: 'gradient',
    description: 'Mango, kiwi and berry stains with playful contrast.',
    bgGradient: 'from-amber-300 via-lime-400 to-fuchsia-500',
    avatarStyle: 'ring-accent',
    previewBg: '#84cc16',
    previewText: '#1a2e05',
    vars: {
      ...
      '--tb-bg3': '#db2777',
      '--tb-text': '#1a2e05',
      '--tb-text2': 'rgba(26,46,5,0.84)',
      '--tb-border': 'rgba(0,0,0,0.2)',
      '--tb-radius': '16px',
      '--tb-font': '"DM Sans", system-ui, sans-serif',
      '--tb-font-display': '"DM Sans", system-ui, sans-serif',
      '--tb-shadow': '0 12px 36px rgba(101,163,13,0.3)',
      '--tb-card-style': 'solid',
      '--tb-link-style': 'card',
    },
  },
  {
    ...
    emoji: '🖌️',
    category: 'luxury',
    description: 'Paint blotches, ink texture and gallery vibe.',
    bgGradient: 'from-orange-300 via-rose-400 to-indigo-500',
    avatarStyle: 'border-gradient',
    previewBg: '#fb923c',
    previewText: '#431407',
    vars: {
      ...
      '--tb-border': 'rgba(67,20,7,0.26)',
      '--tb-radius': '14px',
      '--tb-font': '"Merriweather", Georgia, serif',
      '--tb-font-display': '"Merriweather", Georgia, serif',
      '--tb-shadow': '0 12px 36px rgba(249,115,22,0.28)',
      '--tb-card-style': 'solid',
      '--tb-link-style': 'line',
    },
  },
