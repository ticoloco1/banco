    ...
    fetch('/api/checkout')
      ...
      .then((j) => {
        setApiStatus({
          ...
          supabase: true,
          r2: !!process.env.NEXT_PUBLIC_R2_PUBLIC_BASE_URL,
        });
      })
      .catch(() => {
        setApiStatus({
                  ...
                  >
                    <div className="flex items-center gap-3 min-w-0 flex-1">
                      {row.avatar_url ? (
                        ...
                        <img
                          src={getAssetUrl(row.avatar_url)}
                          alt=""
                    ...
                    <div className="flex items-center gap-2 flex-wrap shrink-0">
                      ...
                      <Link
                        href={`/stats/${encodeURIComponent(row.slug)}`}
        ...
        {tab === 'analytics' && (
          <div className="space-y-6">
            <Link
              ...
              className="inline-flex items-center gap-2 rounded-xl border border-brand/40 bg-brand/10 px-4 py-3 text-sm font-bold text-brand hover:bg-brand/15"
            >
              <BarChart3 className="w-4 h-4" />
              Tráfego detalhado — cidade, entrada, permanência, checkout
            </Link>
