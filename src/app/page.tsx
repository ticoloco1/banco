...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen flex flex-col" style={{ background: 'hsl(var(--background))' }}>
      ...
      <section className="relative overflow-hidden py-24 px-6"
        ...
        <div className="max-w-5xl mx-auto text-center relative z-10">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <Link href="/wallet-offers"
              className="inline-flex items-center gap-2 border-2 border-amber-300/60 text-amber-100 px-6 py-3.5 rounded-xl font-bold text-sm hover:bg-white/10 transition-colors">
              Wallet offers guide (EN)
            </Link>
          </div>
        </div>
        {/* Glow orbs */}
      ...
      <section className="py-12 px-6 border-y" style={{ borderColor: 'hsl(var(--border))', background: 'hsl(var(--secondary))' }}>
        <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-5">
          <div className="card p-5">
            <p className="text-xs font-black text-brand mb-2">FREE PLAN</p>
            <h3 className="text-xl font-black text-[var(--foreground)] mb-2">Freemium mini-site</h3>
            <ul className="text-sm text-[var(--muted-foreground)] space-y-1">
              <li>- 5 links and 6 templates</li>
              <li>- CV paywall (50/50 split)</li>
              <li>- Video paywall (60/40 split)</li>
              <li>- Feed add-on: $3/7d or $10/365d</li>
            </ul>
          </div>
          <div className="card p-5">
            <p className="text-xs font-black text-brand mb-2">USDC POLYGON</p>
            <h3 className="text-xl font-black text-[var(--foreground)] mb-2">Wallet-ready campaigns</h3>
            <p className="text-sm text-[var(--muted-foreground)] mb-3">
              Use Polygon wallet for rewards and NFT delivery. Users opt in to receive offers, and campaigns run with prepaid budget.
            </p>
            <div className="flex gap-2">
              <Link href="/wallet-offers" className="btn-secondary text-xs">Learn wallet flow</Link>
              <Link href="/offers/nft" className="btn-primary text-xs">See NFT offers</Link>
            </div>
          </div>
        </div>
      </section>
